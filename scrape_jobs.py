...
def main():
    ...
    # Chrome 用户数据目录和 Profile
    chrome_user_data = "/Users/iuser/Library/Application Support/Google/Chrome"
    
    # ----------------------------------------------------
    #
    # Profile 3 = '' 这是我自己的资料卡位置，需要进行修改
    #
    # ----------------------------------------------------
    ...
    print(f"\n使用 Chrome Profile: {profile_dir}")
    print(f"账号: Tony Tonglin Zhang (tonytonglinz@gmail.com)")
    print(f"\n⚠️  请先关闭所有 Chrome 窗口!")
    print(f"按 Enter 继续...")
    input()
